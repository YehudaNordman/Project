...
const Testimonials = () => {
    ...
    const featuredReviews = [
        ...
        },
        {
            name: "רונית מזרחי",
            role: "סטודנטית",
            text: "האתר הכי שימושי שנתקלתי בו לאחרונה. חסך לי המון זמן של חיפושים בגוגל מפות.",
            rating: 5
        },
        {
            name: "אלכס גורביץ'",
            role: "צלם נופים",
            text: "הצלחתי לצאת לצילומים זריזים במרכז העיר בזכות הדיוק של זמני הביטחון שהאתר הציע.",
            rating: 5
        },
        {
            name: "שירה אדרי",
            role: "חובבת קניות",
            text: "מצאתי אאוטלט מטורף ליד השדה בברלין בזכות ההמלצות המקומיות. לא הייתי חושבת לצאת בלעדיו!",
            rating: 4
        }
    ];
